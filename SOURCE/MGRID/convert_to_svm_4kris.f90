...
newmesh%cellvtex%elem(ielempent)%ielem(icnp+1) = (ic-1) * defmesh%defsplit%subcell + 4
newmesh%cellvtex%elem(ielempent)%ielem(icnp+2) = (ic-1) * defmesh%defsplit%subcell + 5
newmesh%cellvtex%elem(ielempent)%ielem(icnp+3) = (ic-1) * defmesh%defsplit%subcell + 6
newmesh%cellvtex%elem(ielempent)%ielem(icnp+4) = (ic-1) * defmesh%defsplit%subcell + 7
newmesh%cellvtex%elem(ielempent)%ielem(icnp+5) = (ic-1) * defmesh%defsplit%subcell + 8
newmesh%cellvtex%elem(ielempent)%ielem(icnp+6) = (ic-1) * defmesh%defsplit%subcell + 9
...
do ic = 1, umesh%ncell_int
  ...
  intv(1)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 1         ! internal vertices                
  intv(2)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 2
  intv(3)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 3
  intv(4)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 4
  intv(5)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 5
  intv(6)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 6
  intv(7)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 7
  intv(8)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 8
  intv(9)    = umesh%nvtex + (ic-1) * defmesh%defsplit%intnode + 9
