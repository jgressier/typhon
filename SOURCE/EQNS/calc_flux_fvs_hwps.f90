...
!
! Function
!   Computation of van Leer/Hanel and EFM/Hanel flux for Euler equations
!
!------------------------------------------------------------------------------!
subroutine calc_flux_fvs_hwps(defsolver, defspat, nflux, face, &
