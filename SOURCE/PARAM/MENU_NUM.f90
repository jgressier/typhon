...
module MENU_NUM
  ...
  integer(kpp), parameter :: svm_3q3x3b9 = 36
...
contains
  ...
  subroutine init_svmweights(defsvm)
    ...
    case(svm_2q2x2b4)
       ...
       defsvm%interp_weights(  4, 1:defsvm%ncv) = (/ k2(3), k2(3), k2(1), k2(2) /)
    ...
    case(svm_3q3x3b6)
       ...
       defsvm%interp_weights(1,1._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(1,2._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(1,3._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(1,4._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(1,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(1,6._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(1,7._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(1,8._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(1,9._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(2,1._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(2,2._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(2,3._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(2,4._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(2,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(2,6._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(2,7._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(2,8._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(2,9._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,1._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,2._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,3._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,4._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(3,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(3,6._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(3,7._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,8._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(3,9._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(4,1._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(4,2._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(4,3._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(4,4._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(4,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(4,6._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(4,7._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(4,8._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(4,9._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,1._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,2._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,3._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,4._krp) = -(4._krp*delta**3-6._krp*delta**2-delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(5,5._krp) = (2._krp*delta-1._krp)*(4._krp*delta**2-6._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(5,6._krp) = -delta*(4._krp*delta**2-6._krp*delta+3._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(5,7._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,8._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(5,9._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,1._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,2._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,3._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,4._krp) = (8._krp*delta**3-16._krp*delta**2+9._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(6,5._krp) = -(2._krp*delta-1._krp)*(8._krp*delta**2-6._krp*delta-1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(6,6._krp) = delta*(8._krp*delta**2-8._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(6,7._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,8._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(6,9._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,1._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,2._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,3._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,4._krp) = delta*(8._krp*delta**2-8._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(7,5._krp) = -(2._krp*delta-1._krp)*(8._krp*delta**2-6._krp*delta-1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(7,6._krp) = (8._krp*delta**3-16._krp*delta**2+9._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(7,7._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,8._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(7,9._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,1._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,2._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,3._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,4._krp) = -delta*(4._krp*delta**2-6._krp*delta+3._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(8,5._krp) = (2._krp*delta-1._krp)*(4._krp*delta**2-6._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(8,6._krp) = -(4._krp*delta**3-6._krp*delta**2-delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(8,7._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,8._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(8,9._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(9,1._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(9,2._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(9,3._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(9,4._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(9,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(9,6._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(9,7._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(9,8._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(9,9._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(10,1._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(10,2._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(10,3._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(10,4._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(10,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(10,6._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(10,7._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(10,8._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(10,9._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(11,1._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(11,2._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(11,3._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(11,4._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(11,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(11,6._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(11,7._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(11,8._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(11,9._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(12,1._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(12,2._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(12,3._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(12,4._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(12,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(12,6._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(12,7._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(12,8._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(12,9._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,1._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,2._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(13,3._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,4._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(13,6._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,7._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(13,8._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(13,9._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(14,1._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(14,2._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(14,3._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(14,4._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(14,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(14,6._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(14,7._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(14,8._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(14,9._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,1._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,2._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(15,3._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,4._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(15,6._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,7._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(15,8._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(15,9._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(16,1._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(16,2._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(16,3._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(16,4._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(16,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(16,6._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(16,7._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(16,8._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(16,9._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,1._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,2._krp) = -(4._krp*delta**3-6._krp*delta**2-delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(17,3._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,4._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,5._krp) = (2._krp*delta-1._krp)*(4._krp*delta**2-6._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(17,6._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,7._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(17,8._krp) = -delta*(4._krp*delta**2-6._krp*delta+3._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(17,9._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,1._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,2._krp) = (8._krp*delta**3-16._krp*delta**2+9._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(18,3._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,4._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,5._krp) = -(2._krp*delta-1._krp)*(8._krp*delta**2-6._krp*delta-1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(18,6._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,7._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(18,8._krp) = delta*(8._krp*delta**2-8._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(18,9._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,1._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,2._krp) = delta*(8._krp*delta**2-8._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(19,3._krp) = -delta*(8._krp*delta**2-4._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,4._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,5._krp) = -(2._krp*delta-1._krp)*(8._krp*delta**2-6._krp*delta-1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(19,6._krp) = (4._krp*delta-1._krp)*(4._krp*delta**2-2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,7._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(19,8._krp) = (8._krp*delta**3-16._krp*delta**2+9._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(19,9._krp) = -delta*(8._krp*delta**2-12._krp*delta+3._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,1._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,2._krp) = -delta*(4._krp*delta**2-6._krp*delta+3._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(20,3._krp) = delta*(2._krp*delta-1._krp)**2/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,4._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,5._krp) = (2._krp*delta-1._krp)*(4._krp*delta**2-6._krp*delta+1._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(20,6._krp) = -(8._krp*delta**3-12._krp*delta**2+2._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,7._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(20,8._krp) = -(4._krp*delta**3-6._krp*delta**2-delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(20,9._krp) = delta*(2._krp*delta-3._krp)*(2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(21,1._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(21,2._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(21,3._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(21,4._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(21,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(21,6._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(21,7._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(21,8._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(21,9._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(22,1._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(22,2._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(22,3._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(22,4._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(22,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(22,6._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(22,7._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(22,8._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(22,9._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(23,1._krp) = -(11._krp*delta**3-8._krp*delta**2-2._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(23,2._krp) = delta*(11._krp*delta**2-14._krp*delta+4._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(23,3._krp) = -(11._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(23,4._krp) = delta*(22._krp*delta**2-23._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(23,5._krp) = -(2._krp*delta-1._krp)*(11._krp*delta**2-12._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(23,6._krp) = (22._krp*delta**3-31._krp*delta**2+16._krp*delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(23,7._krp) = -(11._krp*delta**2-5._krp*delta+1._krp)/4._krp
       defsvm%interp_weights(23,8._krp) = (11._krp*delta**3-22._krp*delta**2+12._krp*delta-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(23,9._krp) = -(11._krp*delta**3-20._krp*delta**2+6._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(24,1._krp) = (delta**2+delta+1._krp)/4._krp
       defsvm%interp_weights(24,2._krp) = -delta**3/(delta-1._krp)/2._krp
       defsvm%interp_weights(24,3._krp) = (delta**3+4._krp*delta**2-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(24,4._krp) = -delta*(2._krp*delta**2-delta-4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(24,5._krp) = (2._krp*delta-1._krp)*(delta**2-2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(24,6._krp) = -(2._krp*delta**3+7._krp*delta**2-16._krp*delta+4._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(24,7._krp) = (delta**3-4._krp*delta+1._krp)/(delta-1._krp)/4._krp
       defsvm%interp_weights(24,8._krp) = -(delta**3-4._krp*delta+2._krp)/(delta-1._krp)/2._krp
       defsvm%interp_weights(24,9._krp) = (delta**3+4._krp*delta**2-8._krp*delta-1._krp)/(delta-1._krp)/4._krp
    ...
    case(svm_3q3x3b9)
       ...
       defsvm%interp_weights(1,1) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(1,2) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(1,3) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(1,4) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(1,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(1,6) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(1,7) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(1,8) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(1,9) = (delta**3)/(4._krp*delta-4._krp)

       defsvm%interp_weights(2,1) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(2,2) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(2,3) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(2,4) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(2,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(2,6) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(2,7) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(2,8) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(2,9) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(3,1) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(3,2) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(3,3) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(3,4) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(3,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(3,6) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(3,7) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(3,8) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(3,9) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)

       defsvm%interp_weights(4,1) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(4,2) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(4,3) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(4,4) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(4,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(4,6) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(4,7) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(4,8) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(4,9) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(5,1) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(5,2) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(5,3) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(5,4) = -(4._krp*delta**4-10._krp*delta**3+5._krp*delta**2+3._krp*delta-3._krp)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(5,5) = (8._krp*delta**4-24._krp*delta**3+24._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(5,6) = -(4._krp*delta**3-6._krp*delta**2+3._krp*delta)/(2._krp*delta-2._krp)
       defsvm%interp_weights(5,7) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(5,8) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(5,9) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)

       defsvm%interp_weights(6,1) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(6,2) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(6,3) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(6,4) = (8._krp*delta**3-16._krp*delta**2+12._krp*delta-3._krp)/(2._krp*delta-2._krp)
       defsvm%interp_weights(6,5) = -(16._krp*delta**4-36._krp*delta**3+30._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(6,6) = (8._krp*delta**4-16._krp*delta**3+12._krp*delta**2-3._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(6,7) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(6,8) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(6,9) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(7,1) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(7,2) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(7,3) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(7,4) = (8._krp*delta**4-16._krp*delta**3+12._krp*delta**2-3._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(7,5) = -(16._krp*delta**4-36._krp*delta**3+30._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(7,6) = (8._krp*delta**3-16._krp*delta**2+12._krp*delta-3._krp)/(2._krp*delta-2._krp)
       defsvm%interp_weights(7,7) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(7,8) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(7,9) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)

       defsvm%interp_weights(8,1) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(8,2) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(8,3) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(8,4) = -(4._krp*delta**3-6._krp*delta**2+3._krp*delta)/(2._krp*delta-2._krp)
       defsvm%interp_weights(8,5) = (8._krp*delta**4-24._krp*delta**3+24._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(8,6) = -(4._krp*delta**4-10._krp*delta**3+5._krp*delta**2+3._krp*delta-3._krp)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(8,7) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(8,8) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(8,9) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(9,1) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(9,2) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(9,3) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(9,4) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(9,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(9,6) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(9,7) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(9,8) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(9,9) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)

       defsvm%interp_weights(10,1) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(10,2) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(10,3) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(10,4) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(10,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(10,6) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(10,7) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(10,8) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(10,9) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(11,1) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(11,2) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(11,3) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(11,4) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(11,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(11,6) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(11,7) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(11,8) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(11,9) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)

       defsvm%interp_weights(12,1) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(12,2) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(12,3) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(12,4) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(12,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(12,6) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(12,7) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(12,8) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(12,9) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(13,1) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(13,2) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(13,3) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(13,4) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(13,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(13,6) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(13,7) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(13,8) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(13,9) = (delta**3)/(4._krp*delta-4._krp)

       defsvm%interp_weights(14,1) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(14,2) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(14,3) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(14,4) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(14,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(14,6) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(14,7) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(14,8) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(14,9) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(15,1) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(15,2) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(15,3) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(15,4) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(15,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(15,6) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(15,7) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(15,8) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(15,9) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)

       defsvm%interp_weights(16,1) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(16,2) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(16,3) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(16,4) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(16,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(16,6) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(16,7) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(16,8) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(16,9) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(17,1) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(17,2) = -(4._krp*delta**4-10._krp*delta**3+5._krp*delta**2+3._krp*delta-3._krp)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(17,3) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(17,4) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(17,5) = (8._krp*delta**4-24._krp*delta**3+24._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(17,6) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(17,7) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(17,8) = -(4._krp*delta**3-6._krp*delta**2+3._krp*delta)/(2._krp*delta-2._krp)
       defsvm%interp_weights(17,9) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)

       defsvm%interp_weights(18,1) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(18,2) = (8._krp*delta**3-16._krp*delta**2+12._krp*delta-3._krp)/(2._krp*delta-2._krp)
       defsvm%interp_weights(18,3) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(18,4) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(18,5) = -(16._krp*delta**4-36._krp*delta**3+30._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(18,6) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(18,7) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(18,8) = (8._krp*delta**4-16._krp*delta**3+12._krp*delta**2-3._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(18,9) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(19,1) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(19,2) = (8._krp*delta**4-16._krp*delta**3+12._krp*delta**2-3._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(19,3) = -(8._krp*delta**4-12._krp*delta**3+6._krp*delta**2-delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(19,4) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(19,5) = -(16._krp*delta**4-36._krp*delta**3+30._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(19,6) = (16._krp*delta**4-28._krp*delta**3+16._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(19,7) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(19,8) = (8._krp*delta**3-16._krp*delta**2+12._krp*delta-3._krp)/(2._krp*delta-2._krp)
       defsvm%interp_weights(19,9) = -(8._krp*delta**3-12._krp*delta**2+6._krp*delta-1._krp)/(4._krp*delta-4._krp)

       defsvm%interp_weights(20,1) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(20,2) = -(4._krp*delta**3-6._krp*delta**2+3._krp*delta)/(2._krp*delta-2._krp)
       defsvm%interp_weights(20,3) = (4._krp*delta**3-4._krp*delta**2+delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(20,4) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(20,5) = (8._krp*delta**4-24._krp*delta**3+24._krp*delta**2-9._krp*delta)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(20,6) = -(8._krp*delta**4-20._krp*delta**3+14._krp*delta**2-3._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(20,7) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(20,8) = -(4._krp*delta**4-10._krp*delta**3+5._krp*delta**2+3._krp*delta-3._krp)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(20,9) = (4._krp*delta**4-8._krp*delta**3+delta**2+3._krp*delta-1._krp)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(21,1) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(21,2) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(21,3) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(21,4) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(21,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(21,6) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(21,7) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(21,8) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(21,9) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)

       defsvm%interp_weights(22,1) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(22,2) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(22,3) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)
       defsvm%interp_weights(22,4) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(22,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(22,6) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(22,7) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(22,8) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(22,9) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)

       defsvm%interp_weights(23,1) = -(2._krp*delta**4-delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(23,2) = (2._krp*delta**4-delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(23,3) = -(2._krp*delta**4+7._krp*delta**3-12._krp*delta**2+4._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(23,4) = (4._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(23,5) = -(4._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(23,6) = (4._krp*delta**4+13._krp*delta**3-28._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(23,7) = -(2._krp*delta**3-delta**2)/(4._krp*delta-4._krp)
       defsvm%interp_weights(23,8) = (2._krp*delta**3-delta**2)/(2._krp*delta-2._krp)
       defsvm%interp_weights(23,9) = -(2._krp*delta**3+7._krp*delta**2-12._krp*delta+4._krp)/(4._krp*delta-4._krp)

       defsvm%interp_weights(24,1) = (delta**3)/(4._krp*delta-4._krp)
       defsvm%interp_weights(24,2) = -(delta**3)/(2._krp*delta-2._krp)
       defsvm%interp_weights(24,3) = (delta**3+4._krp*delta**2-4._krp*delta)/(4._krp*delta-4._krp)
       defsvm%interp_weights(24,4) = -(2._krp*delta**4-3._krp*delta**3)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(24,5) = (2._krp*delta**4-3._krp*delta**3)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(24,6) = -(2._krp*delta**4+5._krp*delta**3-20._krp*delta**2+12._krp*delta)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(24,7) = (delta**4-delta**3-delta**2)/(4._krp*delta**2-8._krp*delta+4._krp)
       defsvm%interp_weights(24,8) = -(delta**4-delta**3-delta**2)/(2._krp*delta**2-4._krp*delta+2._krp)
       defsvm%interp_weights(24,9) = (delta**4+3._krp*delta**3-9._krp*delta**2+4._krp)/(4._krp*delta**2-8._krp*delta+4._krp)
