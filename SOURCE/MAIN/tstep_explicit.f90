...
!
! Fonction
!   Explicit integration of the domain
!
!------------------------------------------------------------------------------!
...
! On peut ici decouper le maillage complet en blocs de taille fixe
! pour optimiser l'encombrement memoire et la vectorisation
...
case default
  call erreur("internal error (tstep_explicit)", "unknown or unexpected solver")
endselect
...
!
! Apr 2003 : creation
! Jul 2003 : flux corrections
! Oct 2003 : flux corrections only in unsteady
! Apr 2004 : rename integration_ustdomaine -> integration_grid
! Apr 2004 : split integration_grid -> explicit_step (old name)
! Jul 2004 : call Navier-Stokes solver integration
