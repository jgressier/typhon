...
case(tps_expl)
  call explicit_step(dt, typtemps, defsolver, defspat, deftime, grid%umesh, grid%field, &
                     coupling, ncoupling)
...
case(tps_impl)
  call implicit_step(dt, typtemps, defsolver, defspat, deftime, grid%umesh, grid%field, &
                     coupling, ncoupling)
