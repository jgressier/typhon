...
!
! aug  2002 : creation
! july 2003 : modification arguments integration_ustdomaine
...
! avp  2004 : traitement des listes chainees de structures MGRID
!             changement d'appel integration_ustdomaine -> integration_grid
! june 2004 : desallocation des listes chainees de champ generique en fin de procedure
