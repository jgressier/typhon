...
!
!------------------------------------------------------------------------------!
subroutine calcboco_ust_unif(defboco, ustboco, ustdom, champ, typsolver, defsolver, grid)
...
select case(typsolver)
  case(solKDIF)
    call calcboco_kdif_ust_unif(defboco, ustboco, ustdom, champ, defsolver, grid)
  case(solVORTEX)
    ! rien à faire
  case default
