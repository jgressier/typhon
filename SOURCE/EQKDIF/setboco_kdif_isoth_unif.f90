!------------------------------------------------------------------------------!
! Procedure : setboco_kdif_isoth_unif     Auteur : J. Gressier/E. Radenac
!                                         Date   : Novembre 2003
...
!
!------------------------------------------------------------------------------!
subroutine setboco_kdif_isoth_unif(ustboco, ustdom, champ, temp)
...
real(krp)        :: temp             ! température condition limite
...
do ifb = 1, ustboco%nface
  ...
  do ip = 1, champ%nscal
    champ%etatprim%tabscal(ip)%scal(ighost) = temp
  enddo
enddo

endsubroutine setboco_kdif_isoth_unif
