...
!
!------------------------------------------------------------------------------!
subroutine add_kdif_coupled_radflux(defsolver, umesh, flux, stprim)
...
integer         :: ib                  ! umesh boco definition
...
do ifb = 1, defsolver%defkdif%viewfactor%ncouple
  ...
  ic1       = umesh%facecell%fils(if1,2)    ! ghost cell is always right cell
