...
write(str_w,'(a,i8,a,i4,a,i4,a)') "lecture de maillage :",mesh%ni,"x",mesh%nj,"x",mesh%nk,"noeuds"
...
if (ier /= 0)   call erreur("Problème à la lecture de la coordonnée X")
...
call cg_coord_read_f(unit, ib, iz, 'CoordinateY', RealSingle, (/ 1, 1, 1/), &
                     (/ mesh%ni, mesh%nj,mesh%nk /), vs, ier)
if (ier /= 0)   call erreur("Problème à la lecture de la coordonnée Y")
...
call cg_coord_read_f(unit, ib, iz, 'CoordinateZ', RealSingle, (/ 1, 1, 1/), &
                     (/ mesh%ni, mesh%nj,mesh%nk /), vs, ier)
if (ier /= 0)   call erreur("Problème à la lecture de la coordonnée Z")
