...
!-----------------------------------------------------------------
! Read FLUENT comment or header

  case(fluent_sct_comment)      ! Section : Comment
    call fluent_get_comment(deffluent)
...
! Read FLUENT ???
  ...
  case(fluent_sct_zonebcs)      ! Section : Zone boundary and bcs
    call fluent_get_zonebcs(deffluent, sctid)

!-----------------------------------------------------------------
! Read FLUENT ??? BC FACES Marks ???

  case(fluent_sct_zonebnd)      ! Section : Zone boundary
    call fluent_get_zonebnd(deffluent, sctid)
